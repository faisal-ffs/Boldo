      ...
      <div className='grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8 px-4 md:px-12 lg:px-24 '>
        <div className='w-full'>
          ...
          <div className='w-full mt-8'>
            <div className='mt-4 font-sans ml-8 text-sm md:text-base lg:text-lg'>Pitch termsheet backing validation focus release value proposition..</div>
            <div className='text-start flex  flex-row'>
              <img src={random} alt='random' className='w-8 h-8 ml-8 rounded-full mt-4' />
        ...
        <div className='w-full mt-8 sm:mt-0'>
          ...
          <div className='mt-4 font-sans ml-8'>Seed round direct mailing non-disclosure agreement graphical user interface rockstar.</div>
          <div className='text-start flex flex-row'>
            <img src={random1} alt='random1' className='w-8 h-8 ml-8 rounded-full mt-4' />
        ...
        <div className='w-full mt-8 sm:mt-0'>
          ...
          <div className='mt-4 ml-8 font-sans'>Beta prototype sales iPad Gen-Z marketing network effect value proposition.</div>
          <div className='text-start flex flex-row'>
            <img src={random2} alt='random2' className='w-8 h-8 ml-8  rounded-full mt-4' />
